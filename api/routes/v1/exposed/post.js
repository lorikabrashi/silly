...
router.post('/forgot-password', validations.email, catchException(async (req, res) => {
    validations.checkResults(req);
...
router.post('/reset-password/:code', validations.password, catchException(async (req, res) => {
