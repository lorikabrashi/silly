...
router.post(
    '/invite-peer',
    validations.invitePeer,
    /* catchException(auth.app.validateAccessTokenExp), */ catchException(async (req, res) => {
...
router.post(
    '/invitation-response',
    validations.invitationResponse,
    /* catchException(auth.app.validateAccessTokenExp), */ catchException(async (req, res) => {
        validations.checkResults(req)
...
router.post(
    ...
    catchException(auth.app.validateAccessTokenExp),
...
router.post(
    '/sign-out',
    validations.refreshToken,
    catchException(auth.app.validateAccessToken),
    catchException(async (req, res) => {
        validations.checkResults(req)
...
router.post(
    '/create-project',
    /* catchException(auth.app.validateAccessToken), */ catchException(async (req, res) => {
        const response = {
            message: 'Test',
        }
